...
public class Interfaz extends JFrame {
	...
	public JList<Countent> crearLista() {
		final JList<Countent> ret = new JList<Countent>(new DefaultListModel<Countent>());
	...
	public static class Detalle extends JFrame {
		public Detalle(Countent c) {
			...
			setLocationRelativeTo(null);
			getContentPane().setBackground(Color.WHITE);
			this.add(new JLabel("<html><body>Fecha y hora: "+c.getTimestamp()+
					"<br>Informaci�n de la alerta:<br>"
					+ "&nbsp &nbsp Id de la alerta: "+c.getAlertaId()
					+ "<br> &nbsp &nbsp	Mensaje de alerta: "+c.getMensajeAlerta()
					+ "<br> &nbsp &nbsp Dispositivo: "+c.getIdDispositivo()
					+ "<br> &nbsp &nbsp Ubicaci�n:"
					+ "<br> &nbsp &nbsp &nbsp &nbsp Torre: "+c.getTorre()
					
					+ "<br> &nbsp &nbsp &nbsp &nbsp Apartamento: "+c.getApto()+"</html></body>"));
			setVisible(true);
